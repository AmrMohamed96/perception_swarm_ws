...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/amr/perception_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/amr/perception_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/amr/perception_ws/install)
...
if(NOT "/home/amr/perception_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/amr/perception_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv;/usr/local/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amr/perception_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/local/lib/libopencv_core.so.3.1.0;/usr/local/lib/libopencv_imgproc.so.3.1.0;/usr/local/lib/libopencv_imgcodecs.so.3.1.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amr/perception_ws/devel/.private/cv_bridge/lib;/home/amr/perception_ws/devel/lib;/home/amr/asu_swarm_gp/devel/lib;/opt/ros/kinetic/lib)
